...
#
package Net::Sms::TextMagicClient::Object::GetInboundMessagesNotificationSettingsResponse;
...
__PACKAGE__->method_documentation({
    'inbound_message_notification' => {
    	datatype => 'boolean',
    	base_name => 'inboundMessageNotification',
    	description => 'Should user receive notification about new incoming messages.',
    	format => '',
    	read_only => '',
    		},
    'forwarded_call_notification' => {
    	datatype => 'boolean',
    	base_name => 'forwardedCallNotification',
