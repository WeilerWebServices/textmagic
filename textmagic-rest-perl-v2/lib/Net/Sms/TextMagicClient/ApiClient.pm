...
#
package Net::Sms::TextMagicClient::ApiClient;
...
use Net::Sms::TextMagicClient::Configuration;
...
sub new {
    ...
    my $config;
    if ( $_[0] && ref $_[0] && ref $_[0] eq 'Net::Sms::TextMagicClient::Configuration' ) {
        $config = $_[0];
    } else {
        $config = Net::Sms::TextMagicClient::Configuration->new(@_);
    }
...
sub deserialize
{
    ...
    if (not defined $data) {
        ...
        my $_instance = use_module("Net::Sms::TextMagicClient::Object::$class")->new;
        if (ref $data eq "HASH") {
