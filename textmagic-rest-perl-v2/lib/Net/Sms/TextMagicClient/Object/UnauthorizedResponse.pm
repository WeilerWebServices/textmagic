...
#
package Net::Sms::TextMagicClient::Object::UnauthorizedResponse;
...
__PACKAGE__->class_documentation({description => 'Returned when request has been denied in reason of access problems.',
