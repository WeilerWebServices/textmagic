...
#
package Net::Sms::TextMagicClient::Object::BadRequestResponseErrors;
...
__PACKAGE__->class_documentation({description => 'If it was a **POST** or **PUT** request (and the **message** returned is &#x60;Validation Failed&#x60;), this field may contain **errors** that describe the errors grouped by the input parameter name. ',
