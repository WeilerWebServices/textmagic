...
#
package Net::Sms::TextMagicClient::Role;
use utf8;
...
has api_factory => ( is => 'ro',
                     isa => 'Net::Sms::TextMagicClient::ApiFactory',
                     builder => '_build_af',
                     lazy => 1,
...
has _cfg => ( is => 'ro',
              isa => 'Net::Sms::TextMagicClient::Configuration',
              default => sub { Net::Sms::TextMagicClient::Configuration->new() },
              );

has version_info => ( is => 'ro',
                      isa => 'HashRef',
                      default => sub { {
                          app_name => 'TextMagic API',
                          app_version => '2',
...
sub _build_af {
	...
	return Net::Sms::TextMagicClient::ApiFactory->new(%args);
}

=head1 NAME

Net::Sms::TextMagicClient::Role - a Moose role for the TextMagic API

=head2 TextMagic API version: 2
