...
#
package Net::Sms::TextMagicClient::Object::MessageSession;
...
__PACKAGE__->method_documentation({
    ...
    'source' => {
    	datatype => 'string',
    	base_name => 'source',
    	description => '*   **O** – for TextMagic Online; *   **A** – for API; *   **M** – for TextMagic Messenger; *   **E** – for [Email to SMS](https://docs.textmagic.com/#tag/Send-Email-to-SMS); *   **X** – for [Distribution Lists](https://docs.textmagic.com/#tag/Distribution-Lists). ',
    	format => '',
    	read_only => '',
    		},
    'reference_id' => {
